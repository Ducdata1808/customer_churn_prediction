...
const CHARTS = [
  {
    id: "ov1", file: "chart_overview_01.png",
    section: "Khảo sát Tổng quan",
    title: "Tỷ lệ Kiểu dữ liệu & Kích thước Tập dữ liệu",
    insight: "Tập dữ liệu chứa các bản ghi khách hàng với 21 cột. Hầu hết các đặc trưng (trên 80%) là dạng định tính (Object/Categorical). Dữ liệu này yêu cầu các kĩ thuật mã hóa (Encoding) trước khi đưa vào mô hình Machine Learning.",
    tags: ["Overview", "Data Types", "Pie Chart"]
  },
  {
    id: "ov2", file: "chart_overview_02.png",
    section: "Đánh giá Chất lượng",
    title: "Kiểm tra Dữ liệu Thiếu (Missing Values)",
    insight: "Dữ liệu hoàn toàn sạch, không có bất kỳ giá trị null nào ở tất cả các cột. Tuy nhiên, trong quá trình khảo sát có phát hiện cột TotalCharges chứa chuỗi rỗng và đã được xử lý (imputation).",
    tags: ["Sanity", "Missing Values", "Bar Chart"]
  },
  {
    id: "st1", file: "chart_stats_01.png",
    section: "Thống kê Mô tả",
    title: "Thống kê Đặc trưng Định lượng (Numerical Statistics)",
    insight: "Đặc trưng tenure có trung bình 32.3 tháng. MonthlyCharges nằm trong khoảng $18.25 đến $118.75. Dữ liệu thể hiện độ phân tán tiêu chuẩn, không có dấu hiệu của các cực trị dị thường (outliers) quá mức.",
    tags: ["Stats", "Numerical", "Table"]
  },
  {
    id: "st2", file: "chart_stats_02.png",
    section: "Thống kê Mô tả",
    title: "Thống kê Đặc trưng Định tính (Categorical Summary)",
    insight: "Đa phần khách hàng sử dụng dịch vụ Fiber optic và hợp đồng ngắn hạn (Month-to-month). Đáng chú ý, các dịch vụ cộng thêm thường có mode là 'No', phản ánh thực trạng chưa khai thác hết giá trị KH.",
    tags: ["Stats", "Categorical", "Table"]
  },
  {
    id: 0, file: "chart_00.png",
    section: "Phân phối đơn biến (Biến định lượng)",
  ...
  },
  {
    ...
    section: "Phân phối đơn biến (Biến định tính)",
  ...
  },
  {
    ...
    section: "Phân tích Song biến (Biến định lượng vs Churn)",
  ...
  },
  {
    ...
    section: "Phân tích Song biến (Biến định tính vs Churn)",
  ...
  },
  {
    ...
    section: "Phân tích Song biến (Risk Gap)",
  ...
  },
  {
    ...
    section: "Phân tích Song biến (Dịch vụ bổ trợ)",
  ...
  },
  {
    ...
    section: "Feature Engineering: Phân khúc hóa (Binning)",
  ...
  },
  {
    ...
    section: "Feature Engineering: Tỷ số Tài chính",
  ...
  },
  {
    ...
    section: "Feature Engineering: Hệ thống điểm số",
  ...
  },
  {
    ...
    section: "Feature Engineering: Cờ rủi ro hành vi",
  ...
  },
  {
    ...
    section: "Feature Engineering: Phân khúc Nhân khẩu học",
  ...
  },
  {
    ...
    section: "Tương quan Toàn cục (Pearson)",
  ...
  },
  {
    ...
    section: "Tương quan Toàn cục (Spearman Ordinal)",
  ...
  },
  {
    ...
    section: "Tương quan Toàn cục (Cramér's V)",
  ...
  },
  {
    ...
    section: "Bảng Xếp hạng Sức mạnh Đặc trưng",
...
const SECTIONS = [
  {
    key: "overview",
    label: "Khảo sát Tổng quan",
    emoji: "📋",
    color: "border-teal-200 bg-teal-50 dark:bg-teal-900/10",
    badge: "bg-teal-100 text-teal-700",
    ids: ["ov1"]
  },
  {
    key: "stats",
    label: "Thống kê Mô tả",
    emoji: "📈",
    color: "border-cyan-200 bg-cyan-50 dark:bg-cyan-900/10",
  ...
  },
  {
    ...
    emoji: "🛡️",
    color: "border-rose-200 bg-rose-50 dark:bg-rose-900/10",
  ...
  return (
    <>
      ...
      <div className="mt-5 flex flex-col gap-6 w-full">
        {/* Header + bộ lọc section (chỉ hiện khi không fix sectionKey) */}
        {!sectionKey && (
